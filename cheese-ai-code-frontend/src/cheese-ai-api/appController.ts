...
export async function addApp(body: API.AppAddRequest, options?: { [key: string]: any }) {
  return request<API.BaseResponseLong>(`${api / generated}/app/add`, {
    method: 'POST',
    headers: {
...
export async function deleteAppByAdmin(body: API.DeleteRequest, options?: { [key: string]: any }) {
  return request<API.BaseResponseBoolean>(`${api / generated}/app/admin/delete`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function getAppVoByIdByAdmin(
  ...
  return request<API.BaseResponseAppVO>(`${api / generated}/app/admin/get/vo`, {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function listAppVoByPageByAdmin(
  ...
  return request<API.BaseResponsePageAppVO>(`${api / generated}/app/admin/list/page/vo`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function updateAppByAdmin(
  ...
  return request<API.BaseResponseBoolean>(`${api / generated}/app/admin/update`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function chatToGenCode(
  ...
  return request<API.ServerSentEventString[]>(`${api / generated}/app/chat/gen/code`, {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function deleteApp(body: API.DeleteRequest, options?: { [key: string]: any }) {
  return request<API.BaseResponseBoolean>(`${api / generated}/app/delete`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function deployApp(body: API.AppDeployRequest, options?: { [key: string]: any }) {
  return request<API.BaseResponseString>(`${api / generated}/app/deploy`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function getAppVoById(
  ...
  return request<API.BaseResponseAppVO>(`${api / generated}/app/get/vo`, {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function listGoodAppVoByPage(
  ...
  return request<API.BaseResponsePageAppVO>(`${api / generated}/app/good/list/page/vo`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listMyAppVoByPage(
  ...
  return request<API.BaseResponsePageAppVO>(`${api / generated}/app/my/list/page/vo`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function save(body: API.App, options?: { [key: string]: any }) {
  return request<boolean>(`${api / generated}/app/save`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function updateApp(body: API.AppUpdateRequest, options?: { [key: string]: any }) {
  return request<API.BaseResponseBoolean>(`${api / generated}/app/update`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },

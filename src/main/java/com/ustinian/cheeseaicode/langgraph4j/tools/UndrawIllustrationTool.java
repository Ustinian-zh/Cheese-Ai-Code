package com.ustinian.cheeseaicode.langgraph4j.tools;
...
import com.ustinian.cheeseaicode.langgraph4j.model.enums.ImageCategoryEnum;
...
public class UndrawIllustrationTool {
    ...
    private static final String UNDRAW_API_URL =
            "https://undraw.co/_next/data/_FTM2d-THILOVilGvbqjc/search/%s.json?term=%s";
